...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ViewHolder> {
    ...
    public ItemAdapter(Context context,List<String> companies,List<Map<String,Object>> data){
  ...
  /*  holder.add.setOnClickListener(v -> {
        ...
        collectionReference.add(map).addOnCompleteListener(task -> {
            if (task.isSuccessful())
                Toast.makeText(appContext,"Item added to Cart",Toast.LENGTH_SHORT).show();
